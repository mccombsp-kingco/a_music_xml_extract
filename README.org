...
** Flask Toy
   flask_toy.py implements the Flask web application framework to run on my local machine and provide a web interface.

   There are two forms each using a separate query from demo.py to generate the results on their corresponding pages.

   I have implemented a base.html template that has the title, footer, and both forms. There are three derivative pages:
   1. ./templates/index.html
   2. ./templates/results.html
   3. ./templates/details.html
